...
public class AutoScrollViewPager extends ViewPager {
   ...
   /**
    ...
    private boolean isNeedHandleMoveEvent = false;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                isNeedHandleMoveEvent = true;
                mLastMotionX = x;
                break;
            case MotionEvent.ACTION_MOVE:
                if (isNeedHandleMoveEvent) {
                    if ((x - mLastMotionX > 10 && getCurrentItem() == 0)
                        || (x - mLastMotionX < -10 && getCurrentItem() == getAdapter().getCount() - 1)) {
                        isNeedHandleMoveEvent = false;
                        getParent().requestDisallowInterceptTouchEvent(false);
                    }
                }
                break;
