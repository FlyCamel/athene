...
public class PackageUtils {
    ...
    public static Boolean isTopActivity(Context context, String packageName) {
	 ...
	 /**
     * whether the app whost package's name is packageName is on the top of the stack, and the activityClassName is on
     * <ul>
     * <strong>Attentions:</strong>
     * <li>You should add <strong>android.permission.GET_TASKS</strong> in manifest</li>
     * </ul>
     ...
     * @param context
     * @param packageName
     * @return if params error or task stack is null, return null, otherwise retun whether the app and the activityClassName is on the top of
     * stack
     */
    public static Boolean isCurrentActivity(Context context, String packageName, String activityClassName) {
        if (context == null || StringUtils.isEmpty(packageName) || StringUtils.isEmpty(activityClassName)) {
            return null;
        }
		...
		Log.e("appdownload","current class : "+tasksInfo.get(0).topActivity.getClassName());
        try {
            return packageName.equals(tasksInfo.get(0).topActivity.getPackageName())
                   && activityClassName.equals(tasksInfo.get(0).topActivity.getClassName());
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
