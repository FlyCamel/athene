...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        try {
            db.execSQL("alter table "+DbConstants.IMAGE_SDCARD_CACHE_TABLE_TABLE_NAME+" add "+DbConstants.IMAGE_SDCARD_CACHE_TABLE_VERSION+" integer default 0");
        } catch (Exception e) {
            e.printStackTrace();
            Log.e("appstore", DbConstants.DB_NAME+" DbHelper  onUpgrade error.");
        }
    }
}
