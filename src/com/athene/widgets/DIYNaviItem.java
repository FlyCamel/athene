 ...
 */
public class DIYNaviItem extends LinearLayout {
    ...
    public DIYNaviItem(Context context) {
        this(context, null);
    }

    public DIYNaviItem(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DIYNaviItem(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initLayout() {
        ...
        View view = inflater.inflate(R.layout.diy_navi_item, this, true);
